...
Step1: What will StatsModel do?
      1. StatsModel will accept the GitHub data from flask microservice and will forecast the data for past 1 year based on past 30 days
